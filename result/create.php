<?php
    ...
    $award = $winner = $runnerUp = $third = $awardedDate = $category = "";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if ($awardError == "" && $winnerError == "" && $runnerUpError == "" && $thirdError == "" && $categoryError == "" && $awardedDateError == "") {
            ...
            $sql = "INSERT INTO result(award, category_id, winner, runner_up, third, awarded_date) VALUES ('{$award}', '{$category}', '{$winner}', '{$runnerUp}', '{$third}', '{$awardedDate}')";
                ...
                <div style="display: flex;justify-content: center; align-items: center; ">
                    <div>
                        <div style="display: flex; align-items:center; gap: 12px;">
                            ...
                            <h1 style="color: #225c55;">Create Result</h1>
                        </div>
