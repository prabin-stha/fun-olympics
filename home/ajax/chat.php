...
if ($_POST['method'] === 'fetch') {
    ...
    $messages = $chat->fetchMessage($_SESSION["SESSION_CURRENT_BROADCAST"]);
    ...
    if (!empty($messages)) {
        ...
        echo "<p style='text-align:center; margin-top: 35%; font-weight: 500; color: #2c746b;'>Be the first one to message</p>";
    }
