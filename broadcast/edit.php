<?php
    ...
    $id = $title = $description = $category = $location = $genderRepresentation = $url = $startsAt = $endsAt = $thumbnail = "";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if ($titleError == "" && $descriptionError == "" && $urlError == "" && $startsAtError == "" && $endsAtError == "" && $thumbnailError == "" && $genderRepresentationError == "" && $locationError == "" && $categoryError == "") {
            ...
            $sql = "UPDATE broadcast SET title='$title', description='$modifiedDescription', category_id=$category, location='$location', gender_representation='$genderRepresentation', url='$url', starts_at='$startsAt', thumbnail='$thumbnail', ends_at='$endsAt' WHERE id = $id";
...
<html>
                ...
                <div style="display: flex;justify-content: center; align-items: center; ">
                    <div>
                        <div style="display: flex; align-items:center; gap: 12px;">
                            ...
                            <h1 style="color: #225c55;">Update Broadcast Details</h1>
                        </div>
    ...
    <script>
        ...
        console.log('thumbnail input ',thumbnailInput.value);
